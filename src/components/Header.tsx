        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" } }}>
            ...
            >
              ...
              >
                <MenuItem key="Головна" onClick={handleCloseNavMenu}>
                  <Typography textAlign="center">Головна</Typography>
                </MenuItem>
              </NavLink>
              <NavLink
                to="/news"
              ...
              >
                <MenuItem key="Новини" onClick={handleCloseNavMenu}>
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Відкрити налаштування">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                {/* <Avatar alt="Vadia" src="/static/images/avatar/2.jpg" /> */}
            ...
            >
              ...
              >
                <MenuItem key="Мій профіль" onClick={handleCloseUserMenu}>
